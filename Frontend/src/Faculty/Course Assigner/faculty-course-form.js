...
function FacultyCourseForm() {
  ...
  //                 return <option value={course.title}>{course.title}</option>;
  //               }
  //             })}
  //           </select>
  //         </td>
  ...
  //     setCoreCourses((coreCourses) => [...coreCourses, str1]);
  //   }
  //   while (j <= proElective) {
  //     b = proElective;
  //     let str2 = (
  //       <tr>
  //         <td>Professional Elective Course {j} : </td>
  //         <td>
  //           <select>
  //             {Courses.map((course) => {
  ...
  //     j++;
  //     console.log(coreCourses);
  //     setProCourses((proCourses) => [...proCourses, str2]);
  //   }
  //   while (k <= openElective) {
  //     c = openElective;
  //     let str3 = (
  //       <tr>
  //         <td>Open Elective Course {k} : </td>
  //         <td>
  //           <select>
  //             {Courses.map((course) => {
  ...
  //     k++;
  //     console.log(coreCourses);
  //     setOpenCourses((openCourses) => [...openCourses, str3]);
  //   }
  //   return () => {
  //     setCoreCourses([]);
  //     setProCourses([]);
